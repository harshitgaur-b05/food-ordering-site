...
import naan from "../../assets/naan.jpeg"; // Update the image path
import paneer from "../../assets/paneer.jpeg"; // Update the image path
import daal from "../../assets/dalmakhni.jpeg"; // Update the image path
